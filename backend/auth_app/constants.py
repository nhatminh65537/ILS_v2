...
SESSION_ACTIVE_CACHE_KEY_TEMPLATE = 'session_active:{session_id}'
PASSWORD_RESET_CACHE_KEY_TEMPLATE = 'pwreset_req:{email}'
...
SESSION_ACTIVE_CACHE_TTL_SECONDS = 30

# Password reset (R-AUTH-02: stateless itsdangerous token, 1-hour expiry)
DEFAULT_PASSWORD_RESET_MAX_PER_HOUR = 3
DEFAULT_PASSWORD_RESET_WINDOW_SECONDS = 3600
PASSWORD_RESET_TOKEN_MAX_AGE_SECONDS = 3600
PASSWORD_RESET_SIGNER_SALT = 'auth.password-reset'
