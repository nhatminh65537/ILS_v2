...
|---|------|-------------|-----|
| ~~H1~~ | ~~`api/admin_views.py`~~ | ~~Fixed 2026-04-14~~ | ~~See Fixed section~~ |
...
| ~~H5~~ | ~~`backend/api/views/quizzes.py`~~ | ~~Fixed 2026-04-14~~ | ~~See Fixed section~~ |
...
| # | File | Description | Fix |
|---|------|-------------|-----|
| ~~M1~~ | ~~`api/mixins/rbac_action_permission.py`~~ | ~~Fixed 2026-04-14~~ | ~~See Fixed section~~ |
