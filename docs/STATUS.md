...
> Last updated: 2026-06-01 (RBAC bitmap authz fix F38 + i18n F39 + secret reveal — Integration Test Pass 1 nhóm B/C; xem `docs/reports/2026-06-01_rbac-bitmap-fix-and-followups.md`)
