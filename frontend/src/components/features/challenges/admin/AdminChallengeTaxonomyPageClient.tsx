...
import type { ChallengeCategory, ChallengeTag } from '@/types/challenge.types'

type TaxonomyKind = 'category' | 'tag'

type AdminChallengeTaxonomyPageClientProps = {
  locale: string
  kind: TaxonomyKind
}

type TaxonomyItem = ChallengeCategory | ChallengeTag

export function AdminChallengeTaxonomyPageClient({ locale, kind }: AdminChallengeTaxonomyPageClientProps) {
    ...
    <section className="space-y-6 p-6">
      <header className="space-y-2">
        <nav className="flex flex-wrap items-center gap-1 text-xs text-muted-foreground">
          <Link className="hover:text-foreground hover:underline" href={`/${locale}/admin/challenges`}>
