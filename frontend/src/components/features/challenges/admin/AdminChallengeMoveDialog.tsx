...
import { listChallengeFolderContents } from '@/services/challenges.service'
import type { ChallengeBreadcrumbCrumb, ChallengeExplorerNode } from '@/types/challenge.types'

type AdminChallengeMoveDialogProps = {
  open: boolean
...
export function AdminChallengeMoveDialog({
  open,
  selectionCount,
  movingNodeIds,
  isSubmitting,
